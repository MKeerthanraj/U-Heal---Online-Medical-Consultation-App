    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(DoctorLoginActivity.this, RegisterAsActivity.class);
                                        ...
                                        if (task.isSuccessful()) {
                                            for (QueryDocumentSnapshot DOCUMENT : task.getResult()) {
                                                if(DOCUMENT.getId().matches(fAuth.getUid())){
                                                    counter++;
                                                    Toast.makeText(DoctorLoginActivity.this, "Signed In", Toast.LENGTH_SHORT).show();
                                                    startActivity(new Intent(DoctorLoginActivity.this, DoctorMainAcitivty.class));
                                                    finish();
                                                }
                                            }
                                            if(counter==0){
                                                ...
                                                Toast.makeText(DoctorLoginActivity.this, "Account not found", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    }
                                });
